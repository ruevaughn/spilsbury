...
RSpec.describe FuneralsController, :type => :controller do

  # This should return the minimal set of attributes required to create a valid
  # Funeral. As you add validations to Funeral, be sure to
  ...
  # FuneralsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
